...
namespace FluidMath
{
    ...
    public class G2P
    {
        public double[] computeWeightedVelocity(double[] neighborCellVelocity, double weight)
        {
        ...
        public double[,] computeTerm(double[] weightedVelocity, double[] distanceFromCellToNeighbor)
        {
        ...
        public double[,] computeUpdatedB(double[,] initialB, double[,] term)
        {
            Matrix<double> factor1 = DenseMatrix.OfArray(initialB);
            Matrix<double> factor2 = DenseMatrix.OfArray(term);
            return (factor1 + factor2).ToArray();
        }

        public double[] computeUpdatedParticleVelocity(double[] initialParticleVelocity, double[] weightedVelocity)
        {
        ...
        public double[,] recomputeCMatrix(double[,] B)
        {
            Matrix<double> BMatrix = DenseMatrix.OfArray(B);
            return (BMatrix * 4).ToArray();
        }

        public double[] advectParticle(double[] initialParticlePosition, double[] particleVelocity, double dt)
        {
